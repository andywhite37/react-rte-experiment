...
import {getDogsWithCache, getDogWithCache} from "./service/DogService";
...
export const App = () => {
  ...
  useReaderTaskEither({
    ...
    env: appEnv, // Could stub in a dummy AppEnv here (or whatever mix of dummy & real stuff you want)
    effectDeps: [], // TODO
    eqEffectDeps: {equals: () => true}, // TODO
    // If using redux, you could use these to dispatch actions for updating redux state
    onBefore: () => setDogsRD(RD.pending),
